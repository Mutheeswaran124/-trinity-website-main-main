  ...
  />
          ...
          <div className="col-span-3 space-y-6">
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.3 }}
              className="bg-violet-50 rounded-xl p-5 border-l-4 border-violet-500"
            >
              ...
              <div className="space-y-3">
                {resources.map((resource, index) => (
                  <motion.div
                    ...
                    whileHover={{ scale: 1.02 }}
                    className="group relative overflow-hidden bg-white/80 backdrop-blur-sm border border-gray-100 rounded-xl p-3 hover:shadow-md transition-all duration-300 cursor-pointer"
                  >
                    <div className="flex items-start space-x-3">
                      <div className={`p-1.5 rounded-lg group-hover:scale-110 transition-transform duration-300 ${resource.bgColor}`}>
                        {React.createElement(resource.icon, { className: "h-3 w-3 text-violet-600" })}
                      </div>
                      <div className="flex-1 min-w-0">
                        <h4 className="text-xs font-semibold text-gray-900 group-hover:text-violet-700 transition-colors duration-300 mb-1 line-clamp-2">
                          {resource.title}
                        </h4>
