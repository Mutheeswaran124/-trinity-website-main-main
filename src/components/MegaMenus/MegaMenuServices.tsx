...
const MegaMenuServices: React.FC<MegaMenuServicesProps> = ({ onClose, onGetStarted }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-4 md:p-6 max-w-7xl mx-auto mt-[-30px]">
              ...
              <div className="grid grid-cols-1 gap-2">
                {services.map((service, index) => (
                  <motion.div
                    ...
                    whileHover={{ scale: 1.02, y: -2 }}
                    className="group relative overflow-hidden bg-white/80 backdrop-blur-sm border border-gray-100 rounded-lg p-3 hover:shadow-lg hover:shadow-indigo-500/10 transition-all duration-300 cursor-pointer"
                  >
                    <div className="flex items-start space-x-2">
